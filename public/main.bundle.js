...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_register_register_component__ = __webpack_require__(466);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_home_home_component__ = __webpack_require__(461);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_dashboard_dashboard_component__ = __webpack_require__(459);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_profile_profile_component__ = __webpack_require__(465);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_ng2_pagination__ = __webpack_require__(537);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__ = __webpack_require__(467);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_dashboard_filter_pipe__ = __webpack_require__(460);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_page_not_found_page_not_found_component__ = __webpack_require__(464);
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_17__components_dashboard_filter_pipe__["a" /* FilterPipe */],
                __WEBPACK_IMPORTED_MODULE_17__components_dashboard_filter_pipe__["b" /* OrderByPipe */],
...
var DashboardComponent = (function () {
    function DashboardComponent(authService, router) {
        ...
        this.order = 'orderByScore accending decending'.split(' ');
    }
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.authService.getAllProfile().subscribe(function (profile) {
            _this.users = profile.users;
        }, function (err) {
            console.log(err);
            return false;
        });
    };
    DashboardComponent.prototype.onChange = function (deviceValue) {
        console.log(deviceValue);
    };
    DashboardComponent.prototype.onOrder = function (order) {
...
var FilterPipe = (function () {
    ...
    FilterPipe.prototype.transform = function (value, args) {
        var filter = args ? args[0].toLocaleLowerCase() : null;
        ...
        return filter ? value.filter(function (item) {
            return item.title.toLocaleLowerCase().indexOf(args) > -1;
        }) : value;
    };
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show("You are Registered you can log in", { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(551);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_jwt__ = __webpack_require__(473);
...
var AuthService = (function () {
    ...
    AuthService.prototype.getAllProfile = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        this.loadToken();
        headers.append('Authorization', this.authToken);
        headers.append('Content-Type', 'application/json');
...
// module
exports.push([module.i, ".my-pagination .ng2-pagination .current {\r\n    background: red;\r\n  }\r\n  .ng2-pagination .current {\r\n    background: red;\r\n  }", ""]);
...
module.exports = "<!--<span *ngIf=\"users.length < 1\">No Data Found</span>-->\n<div *ngIf=\"users\" class=\"container\">\n  <form class=\"row\">\n  <div class=\"form-group\">\n    <input type=\"text\" class=\"form-control\" name=\"search\" [(ngModel)]=\"search\" placeholder=\"Search by Name\">\n  </div>\n  <!--<select class=\"form-control\" (change)=\"onChange($event.target.value)\">\n    <option *ngFor=\"let i of devices\">{{i}}</option>\n</select>-->\n<select class=\"form-control\" (change)=\"onOrder($event.target.value)\">\n    <option *ngFor=\"let i of order\">{{i}}</option>\n</select>\n  </form>\n  <h3 class=\"page-header text-center\">Games Arena</h3>\n  <div class=\"row\" >\n  <div class=\"well col-lg-12\" style=\"background-color: rgba(167, 234, 70, 0.89);\" *ngFor=\"let user of users | filterPipe: search | paginate: { itemsPerPage: 3, currentPage: p }\">\n    \n    <div class=\"row\">\n      <div class=\"col-lg-11 col-sm-8 col-xs-8\">\n        <div class=\"row\">\n          <div class=\"col-lg-6 col-sm-6\">\n          <h4>{{user.title}}</h4><small>{{user.platform}}</small>\n          </div>\n          <div class=\"col-lg-3 col-sm-6\">\n          <strong>Genre:</strong>&nbsp;&nbsp;&nbsp;<span>{{user.genre}}</span>\n          </div>\n          <div class=\"col-lg-3 col-sm-6\">\n          <strong>Score:</strong>&nbsp;&nbsp;&nbsp;<span>{{user.score}}</span>\n          </div>\n        </div>\n      </div>\n      <div class=\"col-lg-1 col-sm-4  col-xs-4 text-center\">\n      <h5 *ngIf=\"user.editors_choice == 'Y'\">*<br> Editors Choice</h5>\n      </div>\n    </div>\n    </div>\n  </div>\n  <div class=\"text-center\">\n  <pagination-controls class=\"pagination\" (pageChange)=\"p = $event\" #api></pagination-controls>\n  </div>\n</div>\n"
